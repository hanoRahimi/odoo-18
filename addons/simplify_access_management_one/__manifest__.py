...

{
    ...
    'assets': {
        'web.assets_backend': [
            '/simplify_access_management_one/static/src/js/action_menus.js',
            '/simplify_access_management_one/static/src/js/hide_chatter.js',
            '/simplify_access_management_one/static/src/js/cog_menu.js',
            '/simplify_access_management_one/static/src/js/form_controller.js',
            '/simplify_access_management_one/static/src/js/pivot_grp_menu.js',
            '/simplify_access_management_one/static/src/js/model_field_selector.js',
            '/simplify_access_management_one/static/src/js/search_bar_menu.js',
        ],

    },
    'depends': ['web', 'advanced_web_domain_widget_one'],
    'post_init_hook': 'post_install_action_dup_hook',
    'application': True,
    'installable': True,
    'auto_install': False,
    'live_test_url': 'https://www.terabits.xyz/request_demo?source=index&version=18&app=simplify_access_management',
}
